...
CREATE TABLE IF NOT EXISTS deliveries (
  ...
  date            TEXT DEFAULT '',           -- شمسی "1404/06/20"
  time            INTEGER DEFAULT 0,         -- دقیقه از نیمه‌شب (۰=نامشخص)
  pallets         INTEGER DEFAULT 0,
  loose           INTEGER DEFAULT 0,
  total           INTEGER DEFAULT 0,
  cpp             INTEGER DEFAULT 0,
  item_status     TEXT DEFAULT 'فعلی',       -- فعلی / بایگانی / ارسال
...
CREATE TABLE IF NOT EXISTS dispatches (
  ...
  dispatch_date   TEXT DEFAULT '',           -- شمسی
  dispatch_time   TEXT DEFAULT '',           -- "HH:MM"
...
CREATE TABLE IF NOT EXISTS passwords (
  role       TEXT PRIMARY KEY,              -- 'تحویل' یا 'تحول'
